...
import { Bell, CheckCheck, X, Info, AlertTriangle, CheckCircle, Megaphone } from "lucide-react";
...
const TYPE_CONFIG: Record<string, { icon: any; color: string; bg: string; border: string }> = {
  ...
  annonce:   { icon: Megaphone,     color: "text-purple-600", bg: "bg-purple-50", border: "border-purple-100" },
  default:   { icon: Bell,          color: "text-gray-600",   bg: "bg-gray-50",   border: "border-gray-100" },
};
